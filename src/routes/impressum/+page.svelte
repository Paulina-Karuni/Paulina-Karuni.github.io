...
<svelte:head>
	<title>{m.metadata_impressum_title()}</title>
	<meta name="description" content={m.metadata_impressum_description()} />
</svelte:head>

<Padding>
	<br />
	<h1
		class="text-custom-h text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold font-[Raleway] text-center"
	>
		Impressum
	</h1>
	<br />
	...
	<p>
		...
		Telefon: +49-01638343389<br />
		E-Mail: paulina.karuni@gmail.com<br />
	</p>
	<br />
	<p>
		<strong>Verbraucherstreitbeilegung / Universalschlichtungsstelle</strong>
		<br />Wir nehmen nicht an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teil
	...
	<br />
	<p>
		Design und technische Umsetzung dieser Website: <strong>
			<a href="https://flutterapps.agency" target="_blank" rel="noopener">fab App Agency</a>
		</strong>.
		<br />
		<br />
		Impressum von
		<a href="https://impressum-generator.de" rel="dofollow">Impressum-Generator.de</a>. Powered by
		<a href="https://www.kanzlei-hasselbach.de/" rel="nofollow">Franziska Hasselbach, Bonn</a>.
	</p>
	<br />
</Padding>
